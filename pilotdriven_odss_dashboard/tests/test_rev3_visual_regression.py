...
def test_pinned_manifest_contains_only_the_private_asset_contract() -> None:
    ...
    assert payload["reference_asset"] == {
        "filename": "SQ214_REV3_reference_v9_OFP_VWS.pdf",
        "sha256": "4df2f631cf7bdb80b408c376619dd478e8ad86f1c6d6a380db993b8b0ec54f78",
    }
    assert len(payload["pages"]) == 41
    assert payload["provenance"]["combined_briefing_schema_version"] == "2026-08-25-vws-fir-ofp-v26"
    assert "OFP naming and permanent VWS review" in payload["provenance"]["approval_basis"]
